...
if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
        $stmt = $DB_con->prepare('INSERT INTO events(appeltitre, corps, dateevent, img) VALUES(:uappeltitre, :ucorps, :udateevent, :upic)');
                                ...
                                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <div class="form-group"> <label for="date">
                                            ...
                                            <input type="date" name="dateevent" class="form-control" id="date" placeholder="Entrez la date" value="<?= $datevent ?>">
                                        </div>
