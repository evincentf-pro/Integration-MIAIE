...
if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
    $id = $_GET['edit_id'];
    $stmt_edit = $DB_con->prepare('SELECT id, img, appeltitre, corps, dateevent FROM events WHERE id = :uid');
                                ...
                                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <div class="form-group"> <label for="date">
                                                <b>Date de l'évènement</b></label>
                                            <input type="date" name="dateevent" class="form-control" id="date" placeholder="Entrez la date" value="<?= $dateevent ?>">
                                        </div>
