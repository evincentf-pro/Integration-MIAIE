...
if (isset($_GET['delete_id'])) {
    ...
    $stmt_select = $DB_con->prepare('SELECT img FROM prjregionaux WHERE id =:uid');
    $stmt_select->execute(array(':uid' => $_GET['delete_id']));
    $imgRow = $stmt_select->fetch(PDO::FETCH_ASSOC);
    unlink("images/" . $imgRow['image']);

    // it will delete an actual record from db
    $stmt_delete = $DB_con->prepare('DELETE FROM prjregionaux WHERE id =:uid');
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h1> <b> <i>Liste des prjregionaux à la Une</i></b></h1>
                            <table class="table">
                                <tr>
                                    <td>
                                        <div>
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tbody style="text-align:center">
                                    ...
                                    $stmt = $DB_con->prepare('SELECT * FROM prjregionaux ORDER BY id DESC');
                                    $stmt->execute();
