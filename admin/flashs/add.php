...
if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
        $stmt = $DB_con->prepare('INSERT INTO flashinfos(appeltitre, corps, img) VALUES(:uappeltitre, :ucorps, :upic)');
                                ...
                                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="appeltitre" class="form-control" id="titre" placeholder="Entrez l'appel de titre">
                                        </div>
