...
if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
        $stmt = $DB_con->prepare('INSERT INTO archives(titre, lien, img) VALUES(:utitre, :ulien, :upic)');
                                ...
                                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <div class="form-group"> <label for="Legende">
                                                <b>Lien</b></label>
                                            <input type="text" name="lien" class="form-control" id="exampleInputEmail1" placeholder="Entrez la légende">
                                        </div>
