     ...
     <div class="footer-top">
       <div class="row">
         <div class="large-3 columns" style="text-align:center">
           <div id="text-2" class="widget widget_text">
             <h3 class="widget-title">
               Ministère de l'Intégration Africaine et des Ivoiriens de
               l'Extérieur
             </h3>
             ...
             <div class="textwidget">
               ...
               <p>
                 Adresse: 01 BPV 225 Abidjan 01 <br> Tel : 20 33 12 12 / Fax: 20 22 41 56
               </p>
               <p>
                 Email: info@integration.gouv.ci<br>
           ...
           <div class="widget widget_social clearfix">
             <h3 class="widget-title">Le Miaie sur la toile</h3>

             <ul class="social-icons">
               <li class="twitter">
                 <a target="_blank" href="https://twitter.com/MIAIECI1">Twitter</a>
               </li>

               <li class="facebook">
                 <a target="_blank" href="https://web.facebook.com/MIAIECI/">Facebook</a>
               </li>

               <li class="youtube">
                 <a target="_blank" href="https://www.youtube.com/channel/UC2OqDMyOQ4EJMXvJ17k-4qw">Youtube</a>
               </li>
         ...
         <div class="large-3 columns">
           <div class="widget widget_nav_menu">
             <h3 class="widget-title" style="text-align:center">
               Documents relatifs au minisère
             </h3>
             ...
             <div class="menu-issues-container" style="font-style:italic">
               <ul id="menu-issues" class="menu">
                 ...
                 <li>
                   <a href="#">Programme publics</a>
                 </li>
                 <li>
                   <a href="#">Foire aux questions</a>
                 </li>
                 <li>
                   <a href="#">Bilan organique</a>
                 </li>
                 <li>
         ...
         <div class="large-3 columns" style="text-align:center">
           <img src="images/blog/logo-sticky.png" alt="logo-sticky" class="sticky" />
     ...
     <div class="footer-bottom">
       <div class="row">
         <div class="large-6 columns">
           <div class="copyright">
             Copyright © 2019. LEVEL. Tous droits réservés
           </div>
         </div>

         <div class="large-3 large-offset-3 columns">
           <div class="developed">
             Developed by <a target="_blank" href="#">Vincent Férié</a>
           </div>
         </div>
       </div>
       <!--/ .row-->
