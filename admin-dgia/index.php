...
<head>
    ...
    <style>
        ...
        * {
        ...
        body {
            background: linear-gradient(to bottom, orange, #ffffff);
            color: #454749;
            display: flex;
            align-items: center;
...
<body>
    ...
    <div class="tile">
        ...
        <div class="tile-header">
            <h2 style="color: white; opacity: .75; font-size: 4rem; display: flex; justify-content: center; align-items: center; height: 100%;">D.G.I.A</h2>
        </div>
