...
if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
        $stmt = $DB_con->prepare('INSERT INTO alaune_dgia(appeltitre, titre, legende, chapeau, corps, auteur, datepubli, img) VALUES(:uappeltitre, :utitre, :ulegende, :uchapeau, :ucorps, :uauteur, :udatepubli, :upic)');
