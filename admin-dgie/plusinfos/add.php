...
if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
        $stmt = $DB_con->prepare('INSERT INTO alaune_dgie(appeltitre, titre, legende, chapeau, corps, auteur, datepubli, img) VALUES(:uappeltitre, :utitre, :ulegende, :uchapeau, :ucorps, :uauteur, :udatepubli, :upic)');
...
<script type="text/javascript" src="../../admin/CKEditor/ckeditor/ckeditor.js"></script>
<style type="text/css">
    body {
