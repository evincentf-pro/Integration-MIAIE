...
if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
    $id = $_GET['edit_id'];
    $stmt_edit = $DB_con->prepare('SELECT id, appeltitre, titre, legende, chapeau, corps, auteur, datepubli, img FROM alaune_dgie WHERE id = :uid');
...
if (isset($_POST['btn_save_updates'])) {
    ...
    if (!isset($errMSG)) {
        $stmt = $DB_con->prepare('UPDATE alaune_dgie
