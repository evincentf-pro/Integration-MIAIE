...
$plusinfos = findArticle('plusinfos', $_GET['id']);
                ...
                <article class="medium-12 large-12 columns">
                    ...
                    <div class="post border post-classic slideUp">
                        ...
                        <footer class="entry-footer">
                            ...
                            <div class="right">
                                <span class="posted-on" style=" font-size:100%; color:black;" title="date"><?= $plusinfo['datepubli'] ?></span>
                                <span class="byline" style=" font-size:100%; color:black;" title="auteur"><?= $plusinfo['auteur'] ?></span>
                            </div>
